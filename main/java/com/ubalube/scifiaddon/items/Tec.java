...
public class Tec extends Item implements IHasModel
{
	...
	public Tec(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) 
	{
		...
		if (!playerIn.capabilities.isCreativeMode)
		{
			if(itemstack.isItemDamaged())
			{
				...
				{
					if(playerIn.inventory.hasItemStack(new ItemStack(ModItems.TECAMMO)))
					{
						itemstack.setItemDamage(-clipsize - 1);
						playerIn.inventory.clearMatchingItems(ModItems.TECAMMO, 0, 1, null);
						playerIn.getCooldownTracker().setCooldown(this, ReloadTime);
						worldIn.playSound(playerIn,	playerIn.posX, playerIn.posY, playerIn.posZ, SoundHandler.RELOAD_PISTOLRELOAD, SoundCategory.MASTER, 1, 1);
					}
				}
				else
				{
