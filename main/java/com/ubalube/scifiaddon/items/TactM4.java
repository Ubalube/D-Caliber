...
public class TactM4 extends Item implements IHasModel
{
	...
	public TactM4(String name, CreativeTabs tab) 
	{
		...
		this.addPropertyOverride(new ResourceLocation("aim"), new IItemPropertyGetter()
        {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn)
            {
                ...
                {
                    return entityIn.getActiveItemStack().getItem() != ModItems.TactM4 ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
                }
            }
        });
