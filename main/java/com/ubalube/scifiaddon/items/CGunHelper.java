...
public class CGunHelper extends Item implements IHasModel
{
	...
	public CGunHelper(String name, CreativeTabs tab, int fireRate, int ammocap, int reloadtm, float bulletDamage, int bulletDuration, Item ammunition, String Lore, String Author, TextFormatting color) 
	{
