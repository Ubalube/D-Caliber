...
public class CGunBase extends Item implements IHasModel
{
	...
	public CGunBase(String name, CreativeTabs tab, int fireRate, int ammocap, int reloadtm, int AFiremode, int SFiremode, float bulletDamage, int bulletDuration, Item ammunition) 
	{
