...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/workshop.png");
	private final InventoryPlayer player;
	private final TileEntityWorkshop tileentity;
	
	public GuiWorkshop(InventoryPlayer player, TileEntityWorkshop tileentity) 
	{
		super(new ContainerWorkshop(player, tileentity));
		this.player = player;
