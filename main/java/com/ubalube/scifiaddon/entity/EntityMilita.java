...
public class EntityMilita extends EntityMob
{
	private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityMilita.class, DataSerializers.VARINT);
	
	public EntityMilita(World worldIn) 
	{
		super(worldIn);
	...
	{
		this.tasks.addTask(4, new EntityMilita.AIShoot(this));
    ...
    {
        private final EntityMilita e;
        private int attackStep;
        private int attackTime;

        public AIShoot(EntityMilita en)
        {
            this.e = en;
            this.setMutexBits(3);
        }
