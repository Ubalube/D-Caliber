...
public class EntityApache extends EntityMob
{
	...
	public EntityApache(World worldIn) 
	{
		super(worldIn);
	...
	{
		this.tasks.addTask(2, new EntityApache.AIShoot(this));
		this.tasks.addTask(3, new EntityAIWanderAvoidWater(this, this.getAIMoveSpeed()));
		this.tasks.addTask(3, new EntityApache.AIMoveTowards(this, this.getAIMoveSpeed(), 200, 200));
    ...
    {
        private final EntityApache e;
        private int attackStep;
        private int attackTime;

        public AIShoot(EntityApache en)
        {
            this.e = en;
            this.setMutexBits(3);
        }
