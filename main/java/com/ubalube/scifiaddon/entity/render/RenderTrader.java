...
public class RenderTrader extends RenderBiped<EntityTrader>{

	public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/trader.png");
	
	public RenderTrader(RenderManager manager) {
		super(manager, new ModelTrader(), 0.3F);
	}
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrader entity)
    {
        return TEXTURE;
    }
}
