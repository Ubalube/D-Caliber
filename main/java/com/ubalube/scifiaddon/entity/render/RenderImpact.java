...
public class RenderImpact extends Render<EntityImpact>
{
    ...
    public RenderImpact(RenderManager manager) 
    {
		super(manager);
	}
    
    @Override
    public void doRender(EntityImpact entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityImpact entity)
    {
        return TEXTURES;
    }
}
