...
public class EntityPlasma extends EntityThrowable implements IEntityAdditionalSpawnData
{
    ...
    public EntityPlasma(World worldIn, EntityLivingBase throwerIn)
    {
    ...
    public void onEntityUpdate()
    {
        ...
        if (!this.world.isRemote && (ticksExisted > 1000 || speed < 0.01))
        {
            this.setDead();
        }
    ...
    public void writeEntityToNBT(NBTTagCompound compound)
    {
        ...
        compound.setInteger("Damage", 100);
        compound.setInteger("Damage", 100);
    }
