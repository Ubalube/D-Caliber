...
public class ArmorJuggernaut extends ArmorBase {
	
	private String armorTexturePath;
	private String skinType;
	
	public ArmorJuggernaut(String name, String pathName, ArmorMaterial material, int renderIndex, EntityEquipmentSlot equipmentSlot)
    {
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
		if(itemStack != ItemStack.EMPTY && itemStack.getItem() instanceof ArmorJuggernaut) {
