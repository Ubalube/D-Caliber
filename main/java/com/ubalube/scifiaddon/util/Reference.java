...
public class Reference 
{
	...
	public static final int ENTITY_SIMBOSS = 166;
	public static final int ENTITY_SHIELD = 167;
	public static final int ENTITY_GLITCH = 168;
	public static final int ENTITY_HAZMAT = 169;
