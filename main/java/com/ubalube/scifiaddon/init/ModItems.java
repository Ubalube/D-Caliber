...
public class ModItems 
{
	...
	public static final Item NODE = new CNode("node", main.partTab);
	...
	public static final Item VECTOR = new CGunBase("vector", main.gunTab, 8, 25, 8, 4, 8, 3, 600, ModItems.VECTORAMMO);
