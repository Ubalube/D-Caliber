...
public class WorldGenCustomStructures_Lab implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		case 0:
			...
			generateStructure(LAB, world, random, chunkX, chunkZ, 470, Blocks.GRASS, Biomes.ICE_PLAINS.getBiomeClass());
