...
public class WorldGenCustomStructures_Legion_SmallComp implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		case 0:
			...
			generateStructure(LEGION, world, random, chunkX, chunkZ, 470, Blocks.GRASS, Biomes.PLAINS.getBiomeClass());
