...
public class TileEntityGasbench extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.gasbench";
	}
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = GasbenchRecipes.getInstance().getHarvestorResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = GasbenchRecipes.getInstance().getHarvestorResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
